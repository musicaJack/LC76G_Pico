...
![运行效果](img/hardware1-2.jpg)

## 特性

- **全面的 GPS 数据处理**：准确地从 NMEA 语句中提取和处理地理坐标、速度和航向信息。
...
> **重要说明**：本项目实际使用了自开发的定制主板作为基座，该主板集成了Raspberry Pi Pico、L76X GPS模块和ST7789显示屏。上述接线图适用于自行搭建的场景，如您希望复制完整项目，可参考此接线图进行定制PCB设计。

## 接线图

![硬件连接](img/hardware1-1.jpg)
